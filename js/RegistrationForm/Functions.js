...
const loadIntegrationErp = async (serviceNumber, callback) => {
  $.get(`./php/CadastroAgendamento.php?switchFlag=6`)
    .then(resp => callback())
    .catch(e => alert(e));
}

export default { clearInputs, getCurrentDate, callCadastro, loadCities, loadAssignmentTypes , loadAssignmentTypesLevels }